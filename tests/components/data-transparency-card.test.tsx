...
describe('DataTransparencyCard', () => {
  it('renders explainer text and link with correct DID', () => {
    ...
    expect(link.getAttribute('href')).toBe(
      'https://atproto.at/viewer?uri=did:plc:abc123',
    );
  ...
  it('renders explainer body text about data portability', () => {
    ...
    expect(
      screen.getByText(
        /your professional profile is stored in your Personal Data Server/i,
      ),
    ).toBeDefined();
  });
  ...
  it('has accessible section landmark', () => {
    ...
    expect(
      screen.getByRole('region', { name: 'Your data on the AT Protocol' }),
    ).toBeDefined();
  });
});
